...
```
"""
function adaptive_rwm(x0::Matrix{FT}, log_p::Function, n::Int; Betas::T=nothing,
    ...
    T <: AbstractVector{FT}}
    println("This is Misha version of the package, not the original one! Added Betas and matrix!")
    args = (x0, log_p, n)
...
function adaptive_rwm_(X, D, R, S, P, args, params, x0::Matrix, log_p::Function, n::Int,
    ...
    rng::AbstractRNG, Betas::T=nothing) where {FT <: AbstractFloat,
    T <: AbstractVector{FT}}
