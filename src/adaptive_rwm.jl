...
```
"""
function adaptive_rwm(x0::T, log_p::Function, n::Int; Betas::T=nothing,
    ...
    T <: AbstractVector{FT}}
    println("This is Misha version of the package, not the original one! Added Betas and fixed!")
    args = (x0, log_p, n)
